...
import { conversationIdAtom, LoadConvoAtom, messagesAtom, recepientIdAtom } from "../store/store"
        ...
        <div className="flex px-3 rounded-md py-2 items-center">
                ...
                <div className="flex">
                    <button onClick={onClick}
                        ...
                        >
                        <RiMessage3Line className="text-2xl text-sky-700
